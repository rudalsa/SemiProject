...
public class IdleRemoveAction extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if("POST".equalsIgnoreCase(method)) {
			...
			boolean idleremove = mdao.idleremove(paraMap);
			...
			//	System.out.println("~~~~ 확인용 certification_code : " + certification_code);
				...
				try {
					mail.send_certification_code(user_email, certification_code);
			...
			} // end of if(idleremove)-------------------
			////////////////////////////////////////////////
			
			request.setAttribute("idleremove", idleremove);
	...
	//  super.setRedirect(false);
		super.setViewPage("/WEB-INF/login/idleremove.jsp");		
