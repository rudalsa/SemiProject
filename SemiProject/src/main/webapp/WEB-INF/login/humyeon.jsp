...
body > form > div.div_pwd.mx-auto > span:nth-child(5) {
	...
	const method = "${requestScope.method}";
	  ...
	  */
	  ...
	  $("button.btn-info").click(function(){
		  ...
		  frm.action = "<%= ctxPath%>/login/humyeonVerifycation.bz";
		  frm.method = "post";
		  frm.submit();
	  });
...
function goFind(){
	  ...
	  if(user_id=="" || user_email=="") {
		  ...
		  frm.action = "<%= ctxPath%>/login/humyeonPage.bz"; 
		  frm.method = "post";
		  frm.submit();
	  }
...
<form name="pwdFindFrm" class="text-center">

   <ul style="list-style-type: none;">
      <li style="margin: 25px 0">
          <label style="display: inline-block; width: 90px; color:white;">아이디</label>
          <input type="text" name="user_id" size="25" autocomplete="off" /> 
      </li>
      <li style="margin: 25px 0">
          <label style="display: inline-block; width: 90px; color:white;">이메일</label>
