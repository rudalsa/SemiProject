...
<script type="text/javascript">
	...
	<div id="container" class="text-white">
		<form name="memberRegisterFrm">
			<div class="mb-5">
				<img src="<%= ctxPath %>/img/newshop/logo_steam.svg" />
			</div>
			<div class="div1">
				<label onclick="showInputTag('nameInput');">
				<span style="font-size: 12pt; font-weight: bold;">이름</span> <span style="font-size: 9pt; color: gray;">실명 입력</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;" >아이디</span> <span style="font-size: 9pt; color: gray;">영문 또는 영문+숫자 조합 4~12자</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;">비밀번호</span> <span style="font-size: 9pt; color: gray;">영문 대.소문자+숫자+특수문자 조합 8~15자</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;">비밀번호 확인</span> <span style="font-size: 9pt; color: gray;">비밀번호 재입력</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;">이메일</span> <span style="font-size: 9pt; color: gray;">이메일 형식에 맞게 입력</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;">휴대폰번호</span> <span style="font-size: 9pt; color: gray;">하이픈(-) 없이 입력</span>
				</label>
			...
			<div class="div1">
				...
				<span style="font-size: 12pt; font-weight: bold;">우편번호</span>
				</label>
			...
			<div class="div1 div3">
				...
				<span style="font-size: 12pt font-weight: bold;;">주소</span>
				</label>
			...
			<div class="div1 div2" >
				...
				<span style="font-size: 12pt; font-weight: bold;">생년월일(선택)</span>
				</label>
			...
			<div class="div1 div3">
				<label>
				<span style="font-size: 12pt; font-weight: bold;">성별 선택</span> 
				</label>
				<span id="gender">
					<input type="radio" name="user_gender" id="male" value="1" /><label for="male" class="mr-5">남자</label>
			...
			<div>
				...
				<iframe src="<%= ctxPath%>/iframe_agree/agree.html" width="45%" height="200px" style="border: solid 3px #bfbfbf;"></iframe>
			</div>
			
			<div style="margin-bottom: -5%">
				<input type="button" class="btn btn-primary btnBlue mr-5" value="가입하기" onclick="goRegister()" />
	        	<input type="reset"  class="btn btn-danger btnRed" value="취소하기" onclick="goReset()" />
			</div>
		</form>
	</div>
