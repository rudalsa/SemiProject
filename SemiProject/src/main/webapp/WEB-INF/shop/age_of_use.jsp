...
<div id="p_tag" class="text-center mt-5 mb-5" style="width: 50%; margin: 0 auto; color: #999999;">
	...
	<img src="<%= ctxPath %>/img/main_page_img/15세이용가.jpg" class="mr-1" />
	<img src="<%= ctxPath %>/img/main_page_img/범죄.jpg" class="mr-1" />
	<img src="<%= ctxPath %>/img/main_page_img/약물.jpg" class="mr-1" />
	<img src="<%= ctxPath %>/img/main_page_img/폭력성.jpg" class="mr-1" />
	<img src="<%= ctxPath %>/img/main_page_img/워크이용가.jpg"/>
	<p>정액제 상품</p>
	...
	<span style="font-weight: bold;" class="mr-2" >배급사</span><img src="<%= ctxPath %>/img/blz_sm.jpg" class="mr-4" />
	<span style="font-weight: bold;" class="mr-2" >개발사</span><img src="<%= ctxPath %>/img/blz_sm.jpg" />
